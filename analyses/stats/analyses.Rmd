...
We'll fix each of the non-focal variables' value to the sample mean. The
participant-specific \(alpha\) coefficients are set to 0, which corresponds
to no strong participant-specific contribution to the magnitude of the predicted
reaction times. The \(delta\) coefficient was also set to 0 since it only
shifts the distribution left or right, and doesn't influence the relationship
between the other predictors.
